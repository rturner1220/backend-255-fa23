...
// it is dynamically handled by using a functions.

// GET or regular request when someone goes to http://localhost:3000/hello. When using a function an a route, we almost always have a parameter or handle a response and request
